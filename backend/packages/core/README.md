...
This library is primarily intended to be used as a dependency in your Python applications.

```bash
# Example installation (if published)
pip install gazetrack-core
# Or via uv/poetry/etc.
```
